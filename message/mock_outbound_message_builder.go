...
// Source: github.com/Juneo-io/juneogo/message (interfaces: OutboundMsgBuilder)
//
// Generated by this command:
//
//	mockgen -package=message -destination=message/mock_outbound_message_builder.go github.com/Juneo-io/juneogo/message OutboundMsgBuilder
//
...
func (m *MockOutboundMsgBuilder) Ping(arg0 uint32, arg1 []*p2p.SupernetUptime) (OutboundMessage, error) {
	m.ctrl.T.Helper()
