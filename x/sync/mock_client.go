...
// Source: github.com/Juneo-io/juneogo/x/sync (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_client.go github.com/Juneo-io/juneogo/x/sync Client
//
