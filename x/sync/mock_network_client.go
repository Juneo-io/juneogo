...
// Source: github.com/Juneo-io/juneogo/x/sync (interfaces: NetworkClient)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_network_client.go github.com/Juneo-io/juneogo/x/sync NetworkClient
//
