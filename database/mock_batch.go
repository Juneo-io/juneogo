...
// Source: github.com/Juneo-io/juneogo/database (interfaces: Batch)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_batch.go github.com/Juneo-io/juneogo/database Batch
//
