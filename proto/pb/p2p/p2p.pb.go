...
// Contains supernet id and the related observed supernet uptime of the message
...
type Pong struct {
	...
	// supernet_uptimes contains supernet uptime percentages.
...
var file_p2p_p2p_proto_goTypes = []interface{}{
	...
	(*Ping)(nil),                    // 1: p2p.Ping
	(*SupernetUptime)(nil),            // 2: p2p.SupernetUptime
	(*Pong)(nil),                    // 3: p2p.Pong
...
var file_p2p_p2p_proto_depIdxs = []int32{
	...
	2,  // 23: p2p.Pong.supernet_uptimes:type_name -> p2p.SupernetUptime
