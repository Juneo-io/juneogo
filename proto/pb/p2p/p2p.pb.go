...
func (x *Version) GetTrackedSupernets() [][]byte {
	if x != nil {
...
var file_p2p_p2p_proto_depIdxs = []int32{
	...
	3,  // 23: p2p.Ping.supernet_uptimes:type_name -> p2p.SupernetUptime
	3,  // 24: p2p.Pong.supernet_uptimes:type_name -> p2p.SupernetUptime
