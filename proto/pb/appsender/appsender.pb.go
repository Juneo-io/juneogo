...
type SendAppGossipMsg struct {
	...
	NumValidators    uint64 `protobuf:"varint,2,opt,name=num_validators,json=numValidators,proto3" json:"num_validators,omitempty"`
	NumNonValidators uint64 `protobuf:"varint,3,opt,name=num_non_validators,json=numNonValidators,proto3" json:"num_non_validators,omitempty"`
	NumPeers         uint64 `protobuf:"varint,4,opt,name=num_peers,json=numPeers,proto3" json:"num_peers,omitempty"`
}
...
func (x *SendAppGossipMsg) GetNumValidators() uint64 {
	if x != nil {
...
func (x *SendAppGossipMsg) GetNumNonValidators() uint64 {
	if x != nil {
		return x.NumNonValidators
	}
	return 0
}

func (x *SendAppGossipMsg) GetNumPeers() uint64 {
	if x != nil {
		return x.NumPeers
	}
	return 0
...
func (x *SendCrossChainAppErrorMsg) Reset() {
	*x = SendCrossChainAppErrorMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_appsender_appsender_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendCrossChainAppErrorMsg) Descriptor() ([]byte, []int) {
	return file_appsender_appsender_proto_rawDescGZIP(), []int{7}
}
...
var file_appsender_appsender_proto_rawDesc = []byte{
	...
	,
	...
	0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4a, 0x75,
	0x6e, 0x65, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x6a, 0x75, 0x6e, 0x65, 0x6f, 0x67, 0x6f, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x65, 0x6e, 0x64, 0x65,
...
var file_appsender_appsender_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_appsender_appsender_proto_goTypes = []interface{}{
	...
	(*SendAppGossipSpecificMsg)(nil),     // 4: appsender.SendAppGossipSpecificMsg
	(*SendCrossChainAppRequestMsg)(nil),  // 5: appsender.SendCrossChainAppRequestMsg
	(*SendCrossChainAppResponseMsg)(nil), // 6: appsender.SendCrossChainAppResponseMsg
	(*SendCrossChainAppErrorMsg)(nil),    // 7: appsender.SendCrossChainAppErrorMsg
...
var file_appsender_appsender_proto_depIdxs = []int32{
	...
	4, // 4: appsender.AppSender.SendAppGossipSpecific:input_type -> appsender.SendAppGossipSpecificMsg
	5, // 5: appsender.AppSender.SendCrossChainAppRequest:input_type -> appsender.SendCrossChainAppRequestMsg
	6, // 6: appsender.AppSender.SendCrossChainAppResponse:input_type -> appsender.SendCrossChainAppResponseMsg
	7, // 7: appsender.AppSender.SendCrossChainAppError:input_type -> appsender.SendCrossChainAppErrorMsg
	8, // 8: appsender.AppSender.SendAppRequest:output_type -> google.protobuf.Empty
	...
	8, // 14: appsender.AppSender.SendCrossChainAppResponse:output_type -> google.protobuf.Empty
...
func file_appsender_appsender_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_appsender_appsender_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
