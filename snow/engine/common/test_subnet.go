...
// SupernetTest is a test supernet
type SupernetTest struct {
	T *testing.T
...
func (s *SupernetTest) Default(cant bool) {
...
func (s *SupernetTest) IsBootstrapped() bool {
...
func (s *SupernetTest) Bootstrapped(chainID ids.ID) {
