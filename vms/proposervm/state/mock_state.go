...
// Source: github.com/Juneo-io/juneogo/vms/proposervm/state (interfaces: State)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/proposervm/state/mock_state.go github.com/Juneo-io/juneogo/vms/proposervm/state State
//
