...
func TestAddPermissionlessSupernetDelegatorSerialization(t *testing.T) {
	require := require.New(t)
	...
	simpleAddSupernetTx := &AddPermissionlessDelegatorTx{
		BaseTx: BaseTx{
			BaseTx: avax.BaseTx{
				NetworkID:    constants.MainnetID,
				BlockchainID: constants.PlatformChainID,
	...
	unsignedSimpleAddSupernetTxBytes, err := Codec.Marshal(Version, &unsignedSimpleAddSupernetTx)
	require.NoError(err)
	require.Equal(expectedUnsignedSimpleAddSupernetTxBytes, unsignedSimpleAddSupernetTxBytes)

	complexAddSupernetTx := &AddPermissionlessDelegatorTx{
		BaseTx: BaseTx{
			BaseTx: avax.BaseTx{
				NetworkID:    constants.MainnetID,
				BlockchainID: constants.PlatformChainID,
	...
	unsignedComplexAddSupernetTxBytes, err := Codec.Marshal(Version, &unsignedComplexAddSupernetTx)
	require.NoError(err)
