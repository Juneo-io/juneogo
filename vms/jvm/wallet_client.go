...
// interface of an JVM wallet client for interacting with jvm managed wallet on [chain]
...
// implementation of an JVM wallet client for interacting with jvm managed wallet on [chain]
type walletClient struct {
	requester rpc.EndpointRequester
}

// NewWalletClient returns an JVM wallet client for interacting with jvm managed wallet on [chain]
