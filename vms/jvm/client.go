...
import (
	...
	cjson "github.com/Juneo-io/juneogo/utils/json"
)

var _ Client = (*client)(nil)

// Client for interacting with an JVM (X-Chain) instance
...
// implementation for an JVM client for interacting with jvm [chain]
type client struct {
	requester rpc.EndpointRequester
}

// NewClient returns an JVM client for interacting with jvm [chain]
...
func (c *client) GetFeesPoolValue(ctx context.Context, options ...rpc.Option) (*GetFeesPoolValueReply, error) {
	...
	err := c.requester.SendRequest(ctx, "getFeesPoolValue", &GetFeesPoolValueArgs{}, res, options...)
	return res, err
}
