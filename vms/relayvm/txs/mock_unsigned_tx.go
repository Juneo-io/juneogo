...
func (m *MockUnsignedTx) ConsumedValue(arg0 ids.ID) uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConsumedValue", arg0)
	ret0, _ := ret[0].(uint64)
	return ret0
}

// ConsumedValue indicates an expected call of ConsumedValue.
func (mr *MockUnsignedTxMockRecorder) ConsumedValue(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConsumedValue", reflect.TypeOf((*MockUnsignedTx)(nil).ConsumedValue), arg0)
}

// Outputs mocks base method.
func (m *MockUnsignedTx) Outputs() []*june.TransferableOutput {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Outputs")
	ret0, _ := ret[0].([]*june.TransferableOutput)
	return ret0
}
