...
var (
	...
	errAssetIDCantBeJUNE            = errors.New("asset ID can't be JUNE")
...
type TransformSupernetTx struct {
	...
	// - Must not be the JUNE ID
	AssetID ids.ID `serialize:"true" json:"assetID"`
	// Amount to specify as the amount of rewards that will be initially
	// available in the rewards pool of the supernet.
	RewardsPoolSupply uint64 `serialize:"true" json:"rewardPoolSupply"`
	// Amount to initially specify as the share of rewards given for validators
