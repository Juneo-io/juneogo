...
func (v *verifier) ApricotAtomicBlock(b *blocks.ApricotAtomicBlock) error {
	...
	atomicExecutor.OnAccept.AddTx(b.Tx, status.Committed, v.ctx.JuneAssetID)
...
func (v *verifier) proposalBlock(
	...
	onCommitState.AddTx(b.Tx, status.Committed, v.ctx.JuneAssetID)
	onAbortState.AddTx(b.Tx, status.Aborted, v.ctx.JuneAssetID)
...
func (v *verifier) standardBlock(
	...
	for _, tx := range b.Transactions {
		...
		onAcceptState.AddTx(tx, status.Committed, v.ctx.JuneAssetID)
